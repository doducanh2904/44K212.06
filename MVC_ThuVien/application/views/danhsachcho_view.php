...
<div class="w3-main" style="margin-left:250px">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Độc giả  <?php echo $value['id_docgia']  ?> muốn mượn sách <?php echo $value['id_sach']?></td>
      <td>  <a href="<?php echo base_url(); ?>index.php/ShowDataSach_controller/chapnhan/<?php echo $value['id_muon'] ?>">chấp nhận</a></td> 
       <td>  <a href="<?php echo base_url(); ?>index.php/deleteSach_controller/<?php echo $value['id_sach'] ?>"> không chấp nhận</a></td> 
