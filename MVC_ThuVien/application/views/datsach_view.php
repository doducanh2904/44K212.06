...
<body class="w3-content" style="max-width:1200px;">
  ...
  <a href="<?php echo base_url(); ?>index.php/User_controller/cart" class="w3-bar-item w3-button w3-padding"style="color: #2162f3f5!important;font-size: 18px">cart</a> 
   ...
   <a href="./kho_sach.html" class="w3-bar-item w3-button w3-padding"style="color: #2162f3f5!important;font-size: 18px;padding-top: 0px;">lich su dat sach </a>
                ...
                <div class="datsach">
                  ...
                  <form action="<?php echo base_url(); ?>index.php/User_controller/insertMuon/<?php echo count($mangketqua) ?>"method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                     ...
                     <input  name="idsach<?php echo $i ?>" id="tensach" type="text" class="form-control" placeholder="" aria-label="nhập tên sách" aria-describedby="basic-addon1"value='<?php echo($value->getIdSach()) ?>'>
                    ...
                    <div class="input-group mb-3">
                     ...
                     <input name="tensach<?php echo $i ?>" id="tensach" type="text" class="form-control" placeholder="" aria-label="nhập tên sách" aria-describedby="basic-addon1"value='<?php echo($value->getTenSach()) ?>'>
                    </div>
                    ...
                    <?php $i++; endforeach ?>
                     ...
                     <input name="iddocgia" id="tensach" type="text" class="form-control" placeholder="" aria-label="nhập tên sách" aria-describedby="basic-addon1"value='<?php echo $userInfor['id_docgia']; ?>'>
                    </div>
